...
<template>
        ...
        <q-space class="col-3" />
        <q-input v-model="model.mail" rounded outlined label="E-Mail" class="col-3" type="email"></q-input>
        <q-space class="col-8" />
        ...
        <q-input v-model="model.ort" rounded outlined label="Ortschaft" class="col-3"></q-input>
        <q-space class="col-3" />
