...
import { Respond } from "@/stores/interfaces";
...
<template>
    <div class="row" style="width: 100%">
        <div
            style="background-color: #1976d2; padding: 10px; border-radius: 10px; width: 90%"
        ...
        >
            <q-input
                ...
                label="Frage Title"
            />
            <!--        <q-input model-value="surveyQuestion.title" label="Title">{{ surveyQuestion.title }}</q-input>-->
            <br />
            <q-input
                class="bg-blue-grey-4"
