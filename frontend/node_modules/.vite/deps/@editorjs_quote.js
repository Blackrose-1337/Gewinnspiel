...
var require_bundle = __commonJS({
  "node_modules/@editorjs/quote/dist/bundle.js"(exports, module) {
    !function(t, e) {
      typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define([], e) : typeof exports == "object" ? exports.Quote = e() : t.Quote = e();
    }(window, function() {
      return function(t) {
        var e = {};
        function n(r) {
        ...
        t.exports = function(t2) {
          ...
          return e2.toString = function() {
            ...
            for (var r = {}, o = 0; o < this.length; o++) {
              var i = this[o][0];
              typeof i == "number" && (r[i] = true);
            }
            for (o = 0; o < t3.length; o++) {
              var a = t3[o];
              typeof a[0] == "number" && r[a[0]] || (n && !a[2] ? a[2] = n : n && (a[2] = "(" + a[2] + ") and (" + n + ")"), e2.push(a));
            }
          }, e2;
        };
      }, function(t, e, n) {
        ...
        function h(t2, e2) {
          ...
          else if (t2.insertAt === "bottom")
            n2.appendChild(e2);
          else {
            if (typeof t2.insertAt != "object" || !t2.insertAt.before)
        ...
        function y(t2) {
          ...
          return t2.attrs.type === void 0 && (t2.attrs.type = "text/css"), g(e2, t2.attrs), h(t2, e2), e2;
        }
        function g(t2, e2) {
        ...
        function b(t2, e2) {
          ...
          if (e2.singleton) {
            ...
            t2.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (n2 = function(t3) {
              var e3 = document.createElement("link");
              return t3.attrs.type === void 0 && (t3.attrs.type = "text/css"), t3.attrs.rel = "stylesheet", g(e3, t3.attrs), h(t3, e3), e3;
            }(e2), r2 = function(t3, e3, n3) {
              var r3 = n3.css, o3 = n3.sourceMap, i3 = e3.convertToAbsoluteUrls === void 0 && o3;
        ...
        t.exports = function(t2, e2) {
          ...
          (e2 = e2 || {}).attrs = typeof e2.attrs == "object" ? e2.attrs : {}, e2.singleton || typeof e2.singleton == "boolean" || (e2.singleton = a()), e2.insertInto || (e2.insertInto = "head"), e2.insertAt || (e2.insertAt = "bottom");
          var n2 = p(t2, e2);
        ...
        t.exports = function(t2) {
          ...
          return t2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(t3, e3) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i) ? t3 : (o = i.indexOf("//") === 0 ? i : i.indexOf("/") === 0 ? n + i : r + i.replace(/^\.\//, ""), "url(" + JSON.stringify(o) + ")");
          });
        };
      }, function(t, e, n) {
        "use strict";
        ...
        var a = function() {
          ...
          return i(t2, [{ key: "CSS", get: function() {
            ...
            var e2, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, o2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i2 = document.createElement(t3);
...
// dep:@editorjs_quote
var editorjs_quote_default = require_bundle();
export {
  editorjs_quote_default as default
};
