...
var require_bundle = __commonJS({
  "node_modules/@editorjs/list/dist/bundle.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define([], t) : typeof exports == "object" ? exports.List = t() : e.List = t();
    }(window, function() {
      return function(e) {
        var t = {};
        function n(r) {
        ...
        var r = n(1), i = n(2);
        typeof (i = i.__esModule ? i.default : i) == "string" && (i = [[e.i, i, ""]]);
        ...
        function c(e2, t2) {
          for (var n2 = {}, r2 = [], i2 = 0; i2 < e2.length; i2++) {
            ...
            d2 !== -1 ? (a[d2].references++, a[d2].updater(f2)) : a.push({ identifier: u2, updater: y(f2, t2), references: 1 }), r2.push(u2);
          }
          return r2;
        }
        function l(e2) {
        ...
        e.exports = function(e2, t2) {
          (t2 = t2 || {}).singleton || typeof t2.singleton == "boolean" || (t2.singleton = i());
          var n2 = c(e2 = e2 || [], t2);
          return function(e3) {
            if (e3 = e3 || [], Object.prototype.toString.call(e3) === "[object Array]") {
              ...
              for (var o2 = c(e3, t2), l2 = 0; l2 < n2.length; l2++) {
                var u2 = s(n2[l2]);
                a[u2].references === 0 && (a[u2].updater(), a.splice(u2, 1));
              }
              n2 = o2;
            }
          };
        ...
        var d = function() {
          ...
          return u(e2, null, [{ key: "isReadOnlySupported", get: function() {
            ...
            var t2 = e3 === "ordered" ? this.CSS.wrapperOrdered : this.CSS.wrapperUnordered, n2 = e3 === "ordered" ? "ol" : "ul";
            ...
            var t2, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, r2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, o2 = document.createElement(e3);
...
// dep:@editorjs_list
var editorjs_list_default = require_bundle();
export {
  editorjs_list_default as default
};
