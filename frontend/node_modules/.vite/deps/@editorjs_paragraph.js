      ...
      return function(e) {
        ...
        function u(e2, t2) {
          for (var n2 = {}, r2 = [], o2 = 0; o2 < e2.length; o2++) {
            ...
            f2 !== -1 ? (i[f2].references++, i[f2].updater(d2)) : i.push({ identifier: s2, updater: y(d2, t2), references: 1 }), r2.push(s2);
          }
          return r2;
        }
        function l(e2) {
          ...
          return function(e3) {
            if (e3 = e3 || [], Object.prototype.toString.call(e3) === "[object Array]") {
              ...
              for (var a2 = u(e3, t2), l2 = 0; l2 < n2.length; l2++) {
                var s2 = c(n2[l2]);
                i[s2].references === 0 && (i[s2].updater(), i.splice(s2, 1));
              }
              n2 = a2;
            }
          };
...
// dep:@editorjs_paragraph
var editorjs_paragraph_default = require_bundle();
export {
  editorjs_paragraph_default as default
};
/**
