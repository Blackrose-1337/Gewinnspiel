...
var require_bundle = __commonJS({
  "node_modules/@editorjs/header/dist/bundle.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define([], t) : typeof exports == "object" ? exports.Header = t() : e.Header = t();
    }(window, function() {
      return function(e) {
        var t = {};
        function n(r) {
        ...
        function b(e2) {
          ...
          return e2.attrs.type === void 0 && (e2.attrs.type = "text/css"), m(t2, e2.attrs), v(e2, t2), t2;
        }
        function m(e2, t2) {
        ...
        function y(e2, t2) {
          ...
          if (t2.singleton) {
            ...
            e2.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (n2 = function(e3) {
              ...
              return e3.attrs.type === void 0 && (e3.attrs.type = "text/css"), e3.attrs.rel = "stylesheet", m(t3, e3.attrs), v(e3, t3), t3;
        ...
        function x(e2, t2, n2) {
          var r2 = n2.css, o2 = n2.sourceMap, i2 = t2.convertToAbsoluteUrls === void 0 && o2;
        ...
        e.exports = function(e2) {
          ...
          return e2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e3, t3) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i) ? e3 : (o = i.indexOf("//") === 0 ? i : i.indexOf("/") === 0 ? n + i : r + i.replace(/^\.\//, ""), "url(" + JSON.stringify(o) + ")");
          });
        };
      }, function(e, t, n) {
        "use strict";
        ...
        var i = function() {
          ...
          return t2 = e2, i2 = [{ key: "conversionConfig", get: function() {
            ...
            var t3 = {};
            return r(e3) !== "object" && (e3 = {}), t3.text = e3.text || "", t3.level = parseInt(e3.level) || this.defaultLevel.number, t3;
            ...
            if (this._data = this.normalizeData(e3), e3.level !== void 0 && this._element.parentNode) {
              var t3 = this.getTag();
              t3.innerHTML = this._element.innerHTML, this._element.parentNode.replaceChild(t3, this._element), this._element = t3;
            }
            e3.text !== void 0 && (this._element.innerHTML = this._data.text || "");
...
// dep:@editorjs_header
var editorjs_header_default = require_bundle();
export {
  editorjs_header_default as default
};
/**
