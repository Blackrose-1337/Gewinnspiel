...
var require_bundle = __commonJS({
  "node_modules/editorjs-text-alignment-blocktune/dist/bundle.js"(exports, module) {
    !function(t, e) {
      typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define([], e) : typeof exports == "object" ? exports.AlignmentBlockTune = e() : t.AlignmentBlockTune = e();
    }(self, function() {
      return function() {
        var t = { 966: function(t2, e2, n2) {
          ...
          var i = n2(630).make, a = function() {
            ...
            return e3 = t3, a2 = [{ key: "DEFAULT_ALIGNMENT", get: function() {
              ...
              var e4, n4;
              return (e4 = this.settings) !== null && e4 !== void 0 && e4.blocks && this.settings.blocks.hasOwnProperty(this.block.name) ? this.settings.blocks[this.block.name] : (n4 = this.settings) !== null && n4 !== void 0 && n4.default ? this.settings.default : t3.DEFAULT_ALIGNMENT;
          ...
          function r(t3) {
            return function(t4) {
              ...
              if (t4) {
                ...
                return n3 === "Object" && t4.constructor && (n3 = t4.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(t4) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? i(t4, e3) : void 0;
              }
            }(t3) || function() {
          ...
          function i(t3, e3) {
            ...
            for (var n3 = 0, r2 = new Array(e3); n3 < e3; n3++)
              r2[n3] = t3[n3];
            return r2;
          }
          function a(t3) {
            var e3, n3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, i2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, a2 = document.createElement(t3);
            for (var o in Array.isArray(n3) ? (e3 = a2.classList).add.apply(e3, r(n3)) : n3 && a2.classList.add(n3), i2)
              a2[o] = i2[o];
            return a2;
          }
          ...
          function o(t3) {
            for (var e3 = -1, n3 = 0; n3 < a.length; n3++)
              if (a[n3].identifier === t3) {
                e3 = n3;
                break;
              }
            return e3;
          ...
          function s(t3, e3) {
            for (var n3 = {}, r2 = [], i2 = 0; i2 < t3.length; i2++) {
              ...
              f2 !== -1 ? (a[f2].references++, a[f2].updater(d2)) : a.push({ identifier: l2, updater: g(d2, e3), references: 1 }), r2.push(l2);
            }
            return r2;
          }
          function c(t3) {
          ...
          function d(t3, e3, n3) {
            ...
            if (i2 ? t3.setAttribute("media", i2) : t3.removeAttribute("media"), a2 && typeof btoa != "undefined" && (r2 += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(a2)))), " */")), t3.styleSheet)
          ...
          function g(t3, e3) {
            ...
            if (e3.singleton) {
              ...
              n3 = c(e3), r2 = d.bind(null, n3, e3), i2 = function() {
                !function(t4) {
          ...
          t2.exports = function(t3, e3) {
            (e3 = e3 || {}).singleton || typeof e3.singleton == "boolean" || (e3.singleton = (r === void 0 && (r = Boolean(window && document && document.all && !window.atob)), r));
            var n3 = s(t3 = t3 || [], e3);
            return function(t4) {
              if (t4 = t4 || [], Object.prototype.toString.call(t4) === "[object Array]") {
                ...
                for (var c2 = s(t4, e3), u2 = 0; u2 < n3.length; u2++) {
                  var l2 = o(n3[u2]);
                  a[l2].references === 0 && (a[l2].updater(), a.splice(l2, 1));
                }
                n3 = c2;
              }
            };
...
// dep:editorjs-text-alignment-blocktune
var editorjs_text_alignment_blocktune_default = require_bundle();
export {
  editorjs_text_alignment_blocktune_default as default
};
