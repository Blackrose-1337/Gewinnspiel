...
var require_bundle = __commonJS({
  "node_modules/editorjs-text-color-plugin/dist/bundle.js"(exports, module) {
    !function(t, e) {
      typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define([], e) : typeof exports == "object" ? exports.ColorPlugin = e() : t.ColorPlugin = e();
    }(self, () => (() => {
      var t = { 424: (t2, e2, n2) => {
        ...
        typeof (i = i.__esModule ? i.default : i) == "string" && (i = [[t2.id, i, ""]]);
        ...
        function l(t3, e3) {
          for (var n3 = {}, o2 = [], i2 = 0; i2 < t3.length; i2++) {
            ...
            d2 !== -1 ? (s[d2].references++, s[d2].updater(h2)) : s.push({ identifier: p2, updater: b(h2, e3), references: 1 }), o2.push(p2);
          }
          return o2;
        }
        function a(t3) {
        ...
        function h(t3, e3, n3) {
          ...
          if (i2 ? t3.setAttribute("media", i2) : t3.removeAttribute("media"), s2 && typeof btoa != "undefined" && (o2 += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(s2)))), " */")), t3.styleSheet)
        ...
        function b(t3, e3) {
          ...
          if (e3.singleton) {
            ...
            n3 = a(e3), o2 = h.bind(null, n3, e3), i2 = function() {
              !function(t4) {
          ...
          return function(t4) {
            if (t4 = t4 || [], Object.prototype.toString.call(t4) === "[object Array]") {
              ...
              for (var a2 = l(t4, e3), c2 = 0; c2 < n3.length; c2++) {
                var p2 = r(n3[c2]);
                s[p2].references === 0 && (s[p2].updater(), s.splice(p2, 1));
              }
              n3 = a2;
            }
          };
        ...
        n2(548).toString(), t2.exports = class {
          constructor({ config: t3, api: e3 }) {
            this.api = e3, this.config = t3, this.clickedOnLeft = false, this.pluginType = this.config.type || "text", this.parentTag = this.pluginType === "marker" ? "MARK" : "FONT", this.hasCustomPicker = this.config.customPicker || false, this.color = l(r(this.config.defaultColor, this.pluginType)), this.picker = null, this.icon = null, this.button = null, this.iconClasses = { base: this.api.styles.inlineToolButton, active: this.api.styles.inlineToolButtonActive };
          }
          static get isInline() {
            return true;
          }
          ...
          createButtonIcon() {
            ...
            const e3 = this.pluginType === "marker" ? i : s;
          ...
          wrap(t3) {
            ...
            n3.appendChild(e3), t3.insertNode(n3), this.pluginType === "marker" ? this.wrapMarker(n3) : this.wrapTextColor(n3), this.api.selection.expandToTag(n3);
          }
          wrapMarker(t3) {
          ...
          updateWrapper(t3) {
            this.pluginType === "marker" ? t3.style.backgroundColor = this.color : t3.style.color = this.color;
          }
          removeWrapper(t3) {
          ...
          handleLegacyWrapper(t3, e3) {
            return this.pluginType === "marker" ? t3 : e3 & t3;
          }
          static get sanitize() {
        ...
        */
        ...
        `;
          ...
          set disabled(t3) {
            t3 === null || t3 === false ? this.removeAttribute("disabled") : this.setAttribute("disabled", "");
          }
          set checked(t3) {
            t3 === null || t3 === false ? this.removeAttribute("checked") : this.setAttribute("checked", "");
          }
          set loading(t3) {
            t3 === null || t3 === false ? this.removeAttribute("loading") : this.setAttribute("loading", "");
          }
          connectedCallback() {
            this.btn = this.shadowRoot.getElementById("btn"), this.ico = this.shadowRoot.getElementById("icon"), this.load = document.createElement("xy-loading"), this.load.style.color = "inherit", this.btn.addEventListener("mousedown", function(t3) {
              ...
              t3.keyCode === 13 && t3.stopPropagation();
            }), this.disabled = this.disabled, this.loading = this.loading;
          }
          attributeChangedCallback(t3, e3, n3) {
            t3 == "disabled" && this.btn && (n3 !== null ? (this.btn.setAttribute("disabled", "disabled"), this.href && this.btn.removeAttribute("href")) : (this.btn.removeAttribute("disabled"), this.href && (this.btn.href = this.href))), t3 == "loading" && this.btn && (n3 !== null ? (this.shadowRoot.prepend(this.load), this.btn.setAttribute("disabled", "disabled")) : (this.shadowRoot.removeChild(this.load), this.btn.removeAttribute("disabled"))), t3 == "icon" && this.ico && (this.ico.name = n3), t3 == "href" && this.btn && (this.disabled || (this.btn.href = n3)), t3 == "htmltype" && this.btn && (this.btn.type = n3);
          }
        }
        ...
        */
        ...
        :host(:not([type])) .popcon-content,:host(:not([type])) .popcon-body{
            ...
            ${(t3 || this.type) === "confirm" ? '<xy-icon id="popcon-type" class="popcon-type" name="question-circle" color="var(--waringColor,#faad14)"></xy-icon>' : ""}
            <div class="popcon-content">
                ${(t3 || this.type) !== null ? '<div class="popcon-title" id="title">' + this.title + '</div><xy-button class="btn-close" id="btn-close" icon="close"></xy-button>' : ""}
                <div class="popcon-body">
                    <slot></slot>
                </div>
                ${(t3 || this.type) === "confirm" ? '<div class="popcon-footer"><xy-button id="btn-cancel">' + this.canceltext + '</xy-button><xy-button id="btn-submit" type="primary">' + this.oktext + "</xy-button></div>" : ""}
            </div>
        `;
          }
          get open() {
          ...
          set type(t3) {
            t3 === null || t3 === false ? this.removeAttribute("type") : this.setAttribute("type", t3);
          }
          set oktext(t3) {
          ...
          set open(t3) {
            t3 === null || t3 === false ? (this.removeAttribute("open"), this.parentNode.removeAttribute("open")) : (this.setAttribute("open", ""), this.parentNode.setAttribute("open", ""), this.loading && (this.loading = false));
          }
          set loading(t3) {
            t3 === null || t3 === false ? this.removeAttribute("loading") : this.setAttribute("loading", "");
          }
          connectedCallback() {
            this.remove = false, this.type && (this.titles = this.shadowRoot.getElementById("title"), this.btnClose = this.shadowRoot.getElementById("btn-close")), this.type == "confirm" && (this.btnCancel = this.shadowRoot.getElementById("btn-cancel"), this.btnSubmit = this.shadowRoot.getElementById("btn-submit")), this.addEventListener("transitionend", (t3) => {
              t3.propertyName === "transform" && this.open && (this.type == "confirm" && this.btnSubmit.focus(), this.type == "pane" && this.btnClose.focus(), this.dispatchEvent(new CustomEvent("open")));
            }), this.addEventListener("transitionend", (t3) => {
              t3.propertyName !== "transform" || this.open || (this.remove && this.parentNode.removeChild(this), this.dispatchEvent(new CustomEvent("close")));
          ...
          attributeChangedCallback(t3, e3, n3) {
            t3 == "open" && this.shadowRoot && n3 == null && this.stopfocus, t3 == "loading" && this.shadowRoot && (this.btnSubmit.loading = n3 !== null), t3 == "title" && this.titles && n3 !== null && (this.titles.innerHTML = n3), t3 == "oktext" && this.btnSubmit && n3 !== null && (this.btnSubmit.innerHTML = n3), t3 == "canceltext" && this.btnCancel && n3 !== null && (this.btnCancel.innerHTML = n3);
          }
        }
        ...
        class r extends HTMLElement {
          ...
          show(t3) {
            if (this.popcon = this.querySelector("xy-popcon"), this.disabled)
            ...
            else if (this.popcon || (this.popcon = new s(this.type), this.popcon.type = this.type, this.appendChild(this.popcon), this.popcon.title = this.title || "popover", this.popcon.innerHTML = this.content || "", this.type == "confirm" && (this.popcon.oktext = this.oktext || "confirm", this.popcon.canceltext = this.canceltext || "cancel", this.popcon.onsubmit = () => this.dispatchEvent(new CustomEvent("submit")), this.popcon.oncancel = () => this.dispatchEvent(new CustomEvent("cancel")))), this.trigger === "contextmenu") {
              ...
              (t3.path || t3.composedPath && t3.composedPath()).includes(this.popcon) || (window.xyActiveElement = document.activeElement, this.accomplish ? this.popcon.open = true : this.popcon.open = !this.popcon.open);
            return this.popcon;
          }
          connectedCallback() {
            this.popcon = this.querySelector("xy-popcon"), this.trigger && this.trigger !== "click" || this.addEventListener("click", this.show), this.trigger === "contextmenu" && this.addEventListener("contextmenu", (t3) => {
              ...
              (this.popcon && !e3.includes(this.popcon) && !this.popcon.loading && !e3.includes(this.children[0]) || this.trigger === "contextmenu" && !e3.includes(this.popcon) && t3.which == "1") && (this.popcon.open = false);
            });
          }
          attributeChangedCallback(t3, e3, n3) {
            t3 == "loading" && this.popcon && (this.popcon.loading = n3 !== null), t3 == "title" && this.popcon && n3 !== null && (this.popcon.title = n3), t3 == "oktext" && this.popcon && n3 !== null && (this.popcon.oktext = n3), t3 == "canceltext" && this.popcon && n3 !== null && (this.popcon.canceltext = n3);
          }
        }
        ...
        <section class="color-section">
          ...
          connectedCallback() {
            this.popover = this.shadowRoot.getElementById("popover"), this.popcon = this.shadowRoot.getElementById("popcon"), this.colorBtn = this.shadowRoot.getElementById("color-btn"), this.colors = this.shadowRoot.getElementById("colors"), this.colors.addEventListener("click", (t3) => {
              const e3 = t3.target.closest("button");
              e3 && e3.id !== "custom-picker" && (this.nativeclick = true, this.value = (0, l.handleCSSVariables)(e3.dataset.color), this.onColorPicked(this.value));
          ...
          closeConverter() {
            var _a;
            document.getElementsByClassName(l.CONVERTER_PANEL)[0] && ((_a = document.getElementsByClassName(l.CONVERTER_BTN)[0]) == null ? void 0 : _a.click());
          }
          ...
          attributeChangedCallback(t3, e3, n3) {
            t3 == "disabled" && this.colorBtn && (n3 != null ? this.colorBtn.setAttribute("disabled", "disabled") : this.colorBtn.removeAttribute("disabled")), t3 == "dir" && this.popover && n3 != null && (this.popover.dir = n3);
          }
        }
        ...
        function i(t3) {
          if (function(t4) {
            return (typeof (e3 = t4) == "string" || e3 instanceof String) && t4.includes("--");
            var e3;
          }(t3)) {
      ...
      return n.d = (t2, e2) => {
        for (var o in e2)
          n.o(e2, o) && !n.o(t2, o) && Object.defineProperty(t2, o, { enumerable: true, get: e2[o] });
...
// dep:editorjs-text-color-plugin
var editorjs_text_color_plugin_default = require_bundle();
export {
  editorjs_text_color_plugin_default as default
};
