...
var require_bundle = __commonJS({
  "node_modules/@sotaproject/strikethrough/dist/bundle.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define([], t) : typeof exports == "object" ? exports.Strikethrough = t() : e.Strikethrough = t();
    }(window, function() {
      return function(e) {
        var t = {};
        function n(r) {
        ...
        function c(e2, t2) {
          for (var n2 = {}, r2 = [], o2 = 0; o2 < e2.length; o2++) {
            ...
            f2 !== -1 ? (a[f2].references++, a[f2].updater(d2)) : a.push({ identifier: l2, updater: g(d2, t2), references: 1 }), r2.push(l2);
          }
          return r2;
        }
        function s(e2) {
...
// dep:@sotaproject_strikethrough
var sotaproject_strikethrough_default = require_bundle();
export {
  sotaproject_strikethrough_default as default
};
